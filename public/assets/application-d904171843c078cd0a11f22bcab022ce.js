...
(function() {
  $(document).on('turbolinks:load', function() {
    ...
    es_otro = function(valor) {
      if (valor !== 'Abuelos' && valor !== 'Madre' && valor !== 'Padre' && valor !== 'Padres' && valor !== '') {
        return true;
      }
      return false;
    };
    ...
    $('input[type=radio][name="alumno[vive_con]"]').change(function() {
      if (es_otro(this.value)) {
        return $('#input_otro').prop('disabled', false).show();
      } else {
        return $('#input_otro').prop('disabled', true).hide();
      }
    });
    $('#input_otro').change(function() {
      $('#alumno_vive_con_otro').val(this.value);
